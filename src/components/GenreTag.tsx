...
export default function GenreTag({
  ...
  const wrapperClass = `group inline-flex items-center font-mono transition-all duration-300 uppercase ${onClick || onPlayClick ? "cursor-pointer hover:border-white/50 hover:bg-white/5 hover:text-white" : ""} ${active || isPlaying ? "shadow-[0_0_20px_rgba(255,88,65,0.3)] contrast-125" : ""}`;
