    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center gap-3 border-b border-[#F0F0F0] px-4 sm:px-10 py-4">
        ...
        <div className="flex-1 max-w-[360px]">
          <SearchBar onSelectArtist={handleExplore} compact />
        </div>
      </div>
      ...
      >
        ...
        <div className="border-b border-[#F0F0F0] px-4 sm:px-10 py-6 sm:pt-8 sm:pb-6">
          <div className="flex items-start gap-4 sm:gap-5">
            ...
            <div className="flex-1 min-w-0">
              <h2
                className="text-xl sm:text-[28px] font-semibold text-[#1D1D1F] mb-2 leading-none"
            ...
            <div className="flex gap-1.5 shrink-0">
              ...
              {artistInfo && (
                <button
                  ...
                  className={`flex items-center justify-center border cursor-pointer transition-all duration-150 rounded-sm ml-1.5 ${bookmarkedArtists.has(artistName)
                    ? "border-[#FF4B4B] bg-[#FFF0F0] text-[#FF4B4B]"
                    : "border-[#E5E5E5] bg-[#FAFAFA] text-[#9CA3AF] hover:text-[#1D1D1F] hover:border-[#D1D5DB]"
                    }`}
                  style={{ width: 36, height: 36 }}
