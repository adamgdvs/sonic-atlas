                    ...
                    <>
                        <div className="px-6 py-6 border-b border-[#F0F0F0/60]">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h2 className="text-2xl font-semibold text-[#1D1D1F] mb-1.5 leading-none tracking-tight truncate">{artistName}</h2>
                                    {artistInfo && (
                                        <div className="mb-2 flex flex-wrap gap-1.5">
                                            {artistInfo.genres.slice(0, 3).map(g => <GenreTag key={g} genre={g} onClick={() => { }} />)}
                                        </div>
                                    )}
